        ...
        <div class="container">
          <div class="checkout-addr">
            ...
            <div class="addr-list-wrap">
              <div class="addr-list">
                <ul>
                  <li v-for="(item,index) in addressList" v-if="(addressLimit && index < 3 ) || !addressLimit"
                      v-bind:class="{'check': index == checkedIndex}" @click="checkedIndex=index;selectedAddress=item.addressId">
                    <dl>
                    ...
                    <div class="addr-opration addr-del">
                      <a href="javascript:;" class="addr-del-btn" @click="addressDel(item.addressId)">
                        <svg class="icon icon-del"><use xlink:href="#icon-del"></use></svg>
                      </a>
                    </div>
                    <div class="addr-opration addr-set-default">
                      <a href="javascript:;" class="addr-set-default-btn"
                         @click="setDefault(item.addressId)" v-if="!item.isDefault"><i>设为 默认地址</i></a>
                    </div>
              ...
              <div class="shipping-addr-more" v-show="addressLimit">
                <a class="addr-more-btn up-down-btn" href="javascript:;" @click="addressLimit=false">
                  更多地址
                  <i class="i-up-down">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      setDefault (id) {
        axios.post('/users/addressEdit', {addressId: id}).then((res) => {
          let result = res.data
          if (result.status === 0) {
            this.getAddressList()
          } else {
      ...
      addressDel (id) {
        axios.post('/users/addressDel', {addressId: id}).then((res) => {
          let result = res.data
          if (result.status === 0) {
            this.closeModal()
            this.getAddressList()
...
<style>
  ...
  *, *::after, *::before {
  ...
  .order-item .cart-item-head li:nth-child(2), .order-item .cart-item-head li:nth-child(3), .order-item .cart-item-head li:nth-child(4) {
    width: 16%;
    padding: 0 10px; }
  ...
  /** shipping method **/
  .shipping-method:after, .shipping-method-whiteglove:after {
    visibility: hidden;
    display: block;
    content: " ";
    clear: both; }

  .shipping-method li, .shipping-method-whiteglove li {
    float: left;
    width: 23.8095%;
    height: 162px;
    margin: 0 1.587% 1.587% 0;
    ...
    cursor: pointer;
    color: #333; }
  .shipping-method li:nth-child(4n), .shipping-method-whiteglove li:nth-child(4n) {
    margin-right: 0; }
  .shipping-method li .price, .shipping-method-whiteglove li .price {
    height: 26px;
    font-weight: bold; }
  .shipping-method li .shipping-tips, .shipping-method-whiteglove li .shipping-tips {
    height: 44px;
    margin-top: 20px;
    font-weight: 200;
    font-size: 14px; }
  .shipping-method li .shipping-tips p, .shipping-method-whiteglove li .shipping-tips p {
    line-height: 1.2587;
    color: #999; }
  .shipping-method li .shipping-tips .details, .shipping-method-whiteglove li .shipping-tips .details {
    display: inline-block;
    margin-top: 10px;
    color: #ee7a23;
    line-height: 1.5714;
    font-weight: bold; }
  .shipping-method li .shipping-tips .details .icon-question, .shipping-method-whiteglove li .shipping-tips .details .icon-question {
    width: 15px;
    height: 15px;
    fill: #ee7a23;
    vertical-align: middle; }
  .shipping-method li .shipping-tips .details span, .shipping-method-whiteglove li .shipping-tips .details span {
    text-decoration: underline;
    margin-left: 5px; }
  .shipping-method li.check, .shipping-method li:hover, .shipping-method-whiteglove li.check, .shipping-method-whiteglove li:hover {
    border-color: #ee7a23; }
  ...
  @media only screen and (max-width: 991px) {
    ...
    .shipping-method li:nth-child(4n), .shipping-method-whiteglove li:nth-child(4n) {
      margin-right: 2%; }
    .shipping-method li:nth-child(2n), .shipping-method-whiteglove li:nth-child(2n) {
      margin-right: 0; } }

  @media only screen and (max-width: 767px) {
    .shipping-method, .shipping-method-whiteglove {
      padding: 0 10px; }
    .shipping-method li, .shipping-method-whiteglove li {
      width: 100%;
      margin: 0 0 10px 0;
  ...
  @media only screen and (max-width: 767px) {
    ...
    .order-create-main {
      font-size: 1.4rem; }
    .order-create-main h3, .order-create-main p {
      line-height: 1.5; }
    .order-create-main h3 {
      margin-bottom: 20px; }
    .order-create-main p span {
  ...
  .checkout-page .btn, .checkout .btn {
    min-width: 200px; }
  ...
  @media only screen and (max-width: 767px) {
    ...
    .checkout-page, .checkout {
      padding-bottom: 50px; }
    .checkout-page .header, .checkout .header {
      border-bottom: 1px solid #e9e9e9; }
    .checkout-page .lemall-msg-info, .checkout .lemall-msg-info {
      margin-left: 10px;
      margin-right: 10px; }
    .cart-page {
      padding-bottom: 75px; }
